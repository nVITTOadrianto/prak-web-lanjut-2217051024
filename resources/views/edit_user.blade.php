    ...
    <div class="container position-absolute top-50 start-50 translate-middle bg-warning rounded-5 p-5" style="max-width: 50rem; box-shadow: 0px 0px 50px gray">
        <form action="{{ route('user.update', $user['id']) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="m-2">
                ...
                <div class="d-flex justify-content-center">
                    <input class="form-control-lg" type="text" id="semester" name="semester" value="{{ old('semester', $user->semester) }}">
                </div>
            ...
            <div class="m-2">
                ...
                <div class="d-flex justify-content-center">
                    <select class="form-select-lg" name="fakultas_id" id="fakultas_id" required>
